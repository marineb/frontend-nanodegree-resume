...
var HTMLbioPic = "<div class='pic-container'><img src='%data%' class='biopic'></div>";
var HTMLWelcomeMsg = "<span class='welcome-message'>%data%</span>";

var HTMLskillsStart = "<span id='skillsH3'>Skills:</span><ul id='skills' class='flex-box'></ul>";
...
function initializeMap() {
  ...
  */
  function createMapMarker(placeData) {
    ...
    // changed location.B to location.D -- given code wasn't working.
